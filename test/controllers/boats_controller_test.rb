...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post boats_url, params: { boat: { address: @boat.address, description: @boat.description, name: @boat.name, stars: @boat.stars, user_id: @boat.user_id } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { address: @boat.address, description: @boat.description, name: @boat.name, stars: @boat.stars, user_id: @boat.user_id } }
